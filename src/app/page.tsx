...
const DEFAULT_FREQUENCY = [0, 1, 2, 3, 4, 5, 6];
...
export default function Home() {
  ...
  }, [challenges.length, setIsProModalOpen, setIsModalOpen]);
  ...
  const filteredChallenges = useMemo(() => challenges.filter(challenge =>
    (challenge.frequency || DEFAULT_FREQUENCY).includes(selectedDay)
